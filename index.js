...
/***/ function(module, exports, __webpack_require__) {
	...
	var _configure = __webpack_require__(186);
	...
	var _Feed = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _feed = __webpack_require__(193);
...
/***/ function(module, exports) {
	...
	var RECEVICE_FEED = exports.RECEVICE_FEED = 'RECEVICE_FEED';

	var FAIL_NETWORK = exports.FAIL_NETWORK = 'FAIL_NETWORK';
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.decrement = exports.incrementIfOdd = exports.incrementAsync = exports.increment = undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function feed() {
	    ...
	    switch (action.type) {
	        case _ActionTypes.REQUEST_FEED:
	            return Object.assign({}, state, { loading: true });
	        case _ActionTypes.RECEVICE_FEED:
	            return Object.assign({}, state, {
	                list: state.list.concat(action.feed),
	                loading: false
	            });
	        case _ActionTypes.FAIL_NETWORK:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _feed = __webpack_require__(195);
	...
	var Feed = function (_React$Component) {
	    ...
	    _createClass(Feed, [{
	        ...
	        value: function render() {
	            var _props = this.props;
	            var fetchUserFeed = _props.fetchUserFeed;
	            var feed = _props.feed;

	            var list = feed.list.map(function (item, index) {
	                return _react2.default.createElement(
	                    'li',
	                    { key: index },
	                    item.id
	            ...
	            var loading = feed.loading ? _react2.default.createElement(
	                'div',
	                null,
	                'loading'
	            ) : _react2.default.createElement('div', null);
	            var network = !feed.network ? _react2.default.createElement(
	                'div',
	                null,
	                'network fail'
	            ) : _react2.default.createElement('div', null);
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'button',
	                    { onClick: fetchUserFeed.bind(this) },
	                    '获取feed'
	                ),
	                loading,
	                ' ',
	...
	exports.default = (0, _reactRedux.connect)(function (state) {
	    ...
	    return (0, _redux.bindActionCreators)(FeedActions, dispatch);
	})(Feed);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function requestFeed() {
	    return {
	        type: _ActionTypes.REQUEST_FEED
	    };
	}

	function receviceFeed(feed) {
	    return {
	        type: _ActionTypes.RECEVICE_FEED,
	        feed: feed
	    };
	}
	...
	function failNetwork() {
	    return {
	        type: _ActionTypes.FAIL_NETWORK
	    };
	}
	...
	function fetchUserFeed(user) {
	    return function (dispatch) {
	        ...
	        return fetch('https://api.github.com/users/wsw/received_events?t=' + new Date()).then(function (response) {
	            return response.json();
	        }).then(function (json) {
	            return dispatch(receviceFeed(json));
	        }).catch(function (error) {
	            return dispatch(failNetwork());
	        });
	    };
	}

	exports.fetchUserFeed = fetchUserFeed;
